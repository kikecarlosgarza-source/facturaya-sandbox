...
| `services/handlers/costcoHandler.js` | **EN MODIFICACIÓN ACTIVA — sesión 2026-05-06.** Handler nuevo. Endpoints: `validateCheck` + `generaCFDiXTransaccion`. Sin login (probar simple primero); si Costco rechaza por sesión, agregar login en LOTE-2. | — |
